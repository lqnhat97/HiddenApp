...
public class FragmentContact extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       view = inflater.inflate(R.layout.fragment_fragment_contact, container, false);
        gridView = (GridView) view.findViewById(R.id.gridviewfragmentcontact);
        contactArrayList = new ArrayList<Contact>();
        DataArray();
        contactAdapter = new ContactAdapter(getActivity().getApplicationContext(),contactArrayList);
    ...
    public void DataArray() {
        ...
        if (ContextCompat.checkSelfPermission(getActivity(),
            ...
            while (phones.moveToNext())
            {
                ...
                if(name == null || name =="")
                    name = "User";
                contactArrayList.add(new Contact(phoneNumber,name));
            }
            phones.close();
